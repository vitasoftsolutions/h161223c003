...
export const fetchMaterialsList = createAsyncThunk(
  ...
  async (page, { getState }) => {
    ...
    const response = await axios.get(
      `${base_url}/metarials/?limit=${perPage}&offset=${(page - 1) * perPage}`,
      {
        headers,
      }
    );
...
export const fetchMaterialsListAllData = createAsyncThunk(
  ...
  async (payload) => {
    ...
    // Make the Axios GET request with the headers
    const response = await axios.get(`${base_url}/metarials/`, { headers });
...
export const deleteMaterials = createAsyncThunk(
  ...
  async (payload) => {
    ...
    const response = await axios.delete(`${base_url}/metarials/${payload}/`, {
      headers,
    });

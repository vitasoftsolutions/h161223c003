...
import {
  ...
  contractorben,
  projectlist,
} from "../Actions/PropertyInstallmentAction";

const propertyInstallmentSlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(projectlist.fulfilled, (state, action) => {
        ...
        state.property_data = action.payload.property_data;
        state.purchase_id = action.payload.purchase_id;
...
export default propertyInstallmentSlice.reducer;
